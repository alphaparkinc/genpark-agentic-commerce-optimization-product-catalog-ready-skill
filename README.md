# genpark-agentic-commerce-optimization-product-catalog-ready-skill
...
> **GenPark AI Agent Skill** -- Agentic Commerce Optimization (ACO) catalog transformer for AI shopping agents (ReFiBuy style)
